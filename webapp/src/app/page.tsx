    ...
    <div className="w-full flex-1 flex flex-col items-center">
      ...
      >
        ...
        <div className="w-full max-w-[520px] flex flex-col items-center text-center px-4">
          <p className="text-text-secondary font-bold text-[12px] uppercase tracking-[0.08em] mb-4">
            Banter, backed by escrow.
          </p>

          <h1 className="text-text-primary text-[26px] font-[800] leading-[1.1] tracking-tight mb-6">
            Put Your Money<br />Where Your Mouth Is.
          </h1>

          <p className="text-text-muted text-[13px] font-medium leading-[1.6] max-w-[520px] mb-12">
          ...
          <div className="w-full max-w-[280px] flex flex-col gap-4">
            <Link 
              href="/connect" 
              className="w-full h-[46px] bg-accent text-accent-text text-[14px] font-bold rounded-[10px] flex items-center justify-center hover:opacity-90 transition-opacity"
            >
              Get started
            </Link>
            ...
            <button 
              ...
              className="w-full h-[46px] bg-transparent text-text-primary text-[14px] border border-border rounded-[10px] flex items-center justify-center hover:bg-surface transition-colors"
            >
              How it works
            </button>
          </div>
