  ...
  return (
    <div className="w-full max-w-[800px] flex flex-col pt-8 pb-24 px-4 mx-auto">
      <div className="mt-4 sm:mt-12 bg-surface border border-border rounded-[16px] p-5 sm:p-8 md:p-12 prose prose-invert max-w-none">
        <h1 className="text-text-primary text-[28px] font-[800] mb-8">Terms of Service</h1>
        <p className="text-text-secondary text-[13px] mb-8">Last Updated: July 5, 2026</p>

        <section className="mb-8">
          <h2 className="text-text-primary text-[18px] font-bold mb-4">1. Acceptance of Terms</h2>
        ...
        <section className="mb-8">
          <h2 className="text-text-primary text-[18px] font-bold mb-4">2. Non-Custodial Nature & Assumption of Risk</h2>
          <p className="text-text-muted text-[14px] leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-text-primary text-[18px] font-bold mb-4">3. Oracle and Settlement Limitations</h2>
          <p className="text-text-muted text-[14px] leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-text-primary text-[18px] font-bold mb-4">4. Compliance with Local Laws</h2>
          <p className="text-text-muted text-[14px] leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-text-primary text-[18px] font-bold mb-4">5. Disclaimer of Warranties & Limitation of Liability</h2>
          <p className="text-text-muted text-[14px] leading-relaxed mb-4 uppercase tracking-[0.05em] font-bold text-[#D53131]">
        ...
        <section className="mb-8">
          <h2 className="text-text-primary text-[18px] font-bold mb-4">6. Indemnification</h2>
          <p className="text-text-muted text-[14px] leading-relaxed mb-4">
