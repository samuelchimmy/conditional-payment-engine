    ...
    <div className="w-full max-w-[640px] flex flex-col pt-8">
      ...
      <div className="w-full mb-16 flex flex-col sm:flex-row sm:items-start justify-between gap-8 pt-6 border-t border-divider">
        ...
        <div className="flex flex-col gap-3 w-full sm:w-auto">
          <Link href="#" className="h-[46px] w-full sm:w-[240px] px-5 bg-surface border border-border text-text-primary rounded-[8px] font-bold text-[12px] flex items-center justify-between hover:bg-border transition-colors">
