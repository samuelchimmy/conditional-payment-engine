  ...
  return (
    <div className="w-full max-w-[480px] flex flex-col pt-12">
      <div className="mb-8">
        ...
        <h1 className="text-text-primary text-[32px] font-[800] mt-2">
          What's the bet?
        </h1>
      </div>
      ...
      <div className="flex flex-col gap-6">
        <textarea
          className="w-full h-[140px] bg-surface border border-border rounded-[10px] p-5 text-text-primary text-[15px] resize-none focus:outline-none focus:border-border-emphasis transition-colors"
          placeholder="e.g. Argentina wins the 2026 World Cup final"
        />

        <div className="flex gap-4">
          <div className="flex-1 flex flex-col gap-2">
            <label className="text-text-secondary text-[12px]">Amount (USDT)</label>
            <input
              type="text"
              className="w-full h-[52px] bg-surface border border-border rounded-[10px] px-4 text-text-primary text-[15px] focus:outline-none focus:border-border-emphasis transition-colors"
            />
          </div>
          <div className="flex-1 flex flex-col gap-2">
            <label className="text-text-secondary text-[12px]">Their wallet address</label>
            <input
              type="text"
              className="w-full h-[52px] bg-surface border border-border rounded-[10px] px-4 text-text-primary text-[15px] focus:outline-none focus:border-border-emphasis transition-colors"
            />
        ...
        <div className="flex flex-col gap-2 font-mono text-[14px] mb-4">
