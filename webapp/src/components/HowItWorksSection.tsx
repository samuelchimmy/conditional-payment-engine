...
const faqs = [
  ...
  },
  {
    ...
    answer: "tether.arena offers two ways to protect your wallet so you can recover it if you switch phones or lose your device.\n\nOption 1: Cloud Backup (recommended)\nDuring setup, the app will offer to create an encrypted backup. Here is how it works: the app generates a special encryption key on your device, uses it to encrypt your wallet data, then stores the encrypted data securely and keeps the encryption key in your personal cloud account (e.g., iCloud on iPhone or Google Drive on Android).\n\nThis means no single party can access your wallet alone. The stored data is unreadable without your key, and your cloud account only holds the key without the wallet data. Both parts are needed together, and they are only combined on your device when you log in.\n\nTo restore your wallet on a new device, simply log in with your Google account. The app will automatically retrieve both parts and rebuild your wallet on your device.\n\nOption 2: Manual Backup\nIf you prefer not to use cloud backup, you can write down your 12-word recovery phrase and store it yourself. To restore, you will need to enter all 12 words manually inside the app.\n\nNote: We strongly recommend enabling cloud backup. It provides the same level of security with a much smoother recovery experience. You can always check your backup status or re-run the backup process from Settings."
  },
  {
    question: "How do I send and receive USDT?",
    answer: "You can send and receive USDT directly from the app dashboard. To receive, click the \"Deposit\" button to display your wallet address and QR code. To send or withdraw, simply transfer to any compatible address."
  },
  {
    question: "Are there any fees?",
    answer: "tether.arena charges a small service fee of between 0.5% and 2% on each conditional payment, taken from the bet amount when it settles. There are no subscription or hidden fees. On top of that, a tiny blockchain network fee is required to settle on-chain, but the app is designed so you never have to buy a separate gas token, network fees are handled in USDT on Celo and are typically fractions of a cent."
  },
  {
      ...
      >
        ...
        <div className="w-full flex flex-col text-left mt-24">
          ...
          >
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=1523511863298621531" target="_blank" rel="noopener noreferrer" className="w-full h-[54px] bg-surface text-text-primary border border-border font-bold rounded-[10px] flex items-center justify-center hover:bg-border transition-colors">
