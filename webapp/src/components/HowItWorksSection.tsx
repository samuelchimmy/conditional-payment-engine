      ...
      >
        ...
        <div className="w-full flex flex-col text-left mt-24">
          ...
          >
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=1523511863298621531&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Ftarena.xyz%2Fdashboard&integration_type=0&scope=identify+bot+guilds.members.read+activities.write+relationships.write+role_connections.write+openid+gateway.connect+identify.premium+guilds+guilds.channels.read+rpc+activities.invites.write" target="_blank" rel="noopener noreferrer" className="w-full h-[54px] bg-surface text-text-primary border border-border font-bold rounded-[10px] flex items-center justify-center hover:bg-border transition-colors">
